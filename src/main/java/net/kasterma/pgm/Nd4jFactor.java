 ...
 */
@Log4j2
public final class Nd4jFactor implements Factor {
    private final INDArray vals;
    private final List<Integer> scope;

    public Nd4jFactor(final INDArray vals, final List<Integer> scope) {
        this.vals = vals;
        this.scope = scope;
    }
     ...
     * Product of factors.
     */
    public Nd4jFactor mul(Nd4jFactor other) {
    ...
    public static void main( String[] args ) {
        ...
        log.info("a4 shape {} stride {}", a4.shape(), a4.stride());
    }
}
